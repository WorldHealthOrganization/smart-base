...
Source reference for Test Scenario - can be URL, canonical reference, or inline instance 
    ...
    "element" : [
      {
        ...
        "definition" : "Source reference for Test Scenario - can be URL, canonical reference, or inline instance"
      },
      {
