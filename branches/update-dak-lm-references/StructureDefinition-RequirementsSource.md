...
Source reference for Requirements - can be URL, canonical reference, or inline instance 
    ...
    "element" : [
      {
        ...
        "definition" : "Source reference for Requirements - can be URL, canonical reference, or inline instance"
      },
      {
