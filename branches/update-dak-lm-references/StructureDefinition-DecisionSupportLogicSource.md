...
| Active as of 2025-10-09 | *Computable Name*:DecisionSupportLogicSource |

 
Source reference for Decision Support Logic - can be URL, canonical reference, or inline instance 
    ...
    "element" : [
      {
        ...
        "definition" : "Source reference for Decision Support Logic - can be URL, canonical reference, or inline instance"
      },
      {
