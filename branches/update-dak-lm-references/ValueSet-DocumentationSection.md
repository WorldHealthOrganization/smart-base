...
| Active as of 2025-10-09 | *Computable Name*:DocumentationSection |
...
* Include all codes defined in `http://smart.who.int/base/CodeSystem/DocumentationSection` version Not Stated (use latest from terminology server)
