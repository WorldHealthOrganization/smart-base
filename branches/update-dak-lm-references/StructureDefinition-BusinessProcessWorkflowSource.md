...
| Active as of 2025-10-09 | *Computable Name*:BusinessProcessWorkflowSource |

 
Source reference for Business Process Workflow - can be URL, canonical reference, or inline instance 
    ...
    "element" : [
      {
        ...
        "definition" : "Source reference for Business Process Workflow - can be URL, canonical reference, or inline instance"
      },
      {
