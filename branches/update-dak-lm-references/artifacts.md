...
| [Business Process Workflow Source](StructureDefinition-BusinessProcessWorkflowSource.md) | Source reference for Business Process Workflow - can be URL, canonical reference, or inline instance |
...
| [Core Data Element Source](StructureDefinition-CoreDataElementSource.md) | Source reference for Core Data Element - can be URL, canonical reference, or inline instance |
| [Decision Support Logic Source](StructureDefinition-DecisionSupportLogicSource.md) | Source reference for Decision Support Logic - can be URL, canonical reference, or inline instance |
...
| [Generic Persona Source](StructureDefinition-GenericPersonaSource.md) | Source reference for Generic Persona - can be URL, canonical reference, or inline instance |
| [Health Interventions Source](StructureDefinition-HealthInterventionsSource.md) | Source reference for Health Interventions - can be URL, canonical reference, or inline instance |
...
| [Program Indicator Source](StructureDefinition-ProgramIndicatorSource.md) | Source reference for Program Indicator - can be URL, canonical reference, or inline instance |
| [Requirements Source](StructureDefinition-RequirementsSource.md) | Source reference for Requirements - can be URL, canonical reference, or inline instance |
...
| [Test Scenario Source](StructureDefinition-TestScenarioSource.md) | Source reference for Test Scenario - can be URL, canonical reference, or inline instance |
...
| [User Scenario Source](StructureDefinition-UserScenarioSource.md) | Source reference for User Scenario - can be URL, canonical reference, or inline instance |
