...
"""
    ...
    def _replace_lang_source(self, html: str, lang: str, label: str, src_file: str) -> str:
        ...
        while pos < len(html):
            ...
            # Preserve blocks that contain FHIR documentation hyperlinks generated by the
            # IG Publisher (e.g. <a href="http://hl7.org/fhir/...">fhir:id</a>).
            # Replacing those with plain Prism-highlighted text would lose the links.
            if '<a href=' in pre_content:
                parts.append(html[pos:close_pos + len(close_tag)])
                pos = close_pos + len(close_tag)
                continue
