...
def extract(resources: Dict[str, Any]) -> None:
    """
    Main extraction function that processes all input files.

    Args:
        resources (Dict[str, Any]): Dictionary to store extracted code systems, value sets, and concept maps.
    """
    for inputfile_name in find_files():
        extract_to_resources(inputfile_name, resources)
