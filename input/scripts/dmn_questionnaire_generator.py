...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("input/fsh/questionnaires"),
        help="Directory to save questionnaire FSH files (default: input/fsh/questionnaires)"
    )
    
    args = parser.parse_args()
    
    generator = DMNQuestionnaireGenerator(logger)
    success = generator.generate_questionnaires_from_dmn_files(args.dmn_dir, args.output_dir)
