    ...
    "https://worldhealthorganization.github.io/smart-base/ValueSet-YourValueSet.jsonld",
    {
      "yourProperty": {
        ...
        "schema:rangeIncludes": {
          "@id": "https://worldhealthorganization.github.io/smart-base/ValueSet-YourValueSet.jsonld"
        }
      }
    }
  ],
...
This requirements document provides comprehensive guidance for implementing robust, standards-compliant systems that use WHO SMART Base JSON-LD ValueSet vocabularies.