...
* ^status = #active
* id 1..1 SGid "Indicator ID" "Identifier for the program indicator"
...
* references 0..* SGid "References" "References to Dublin Core metadata elements providing additional context"