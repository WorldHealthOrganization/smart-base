...
* activity 1..1 markdown "Activity" "Description of the activity being performed"
* actor 0..* Reference(SGActor) "Actor" "The actor(s) that should fulfill the requirement"
* capability[x] 0..1 markdown or Coding "Capability" "Capability achieved by an actor fulfilling the requirement (I want)"
* benefit[x] 0..1 markdown or Coding "Benefit" "Benefit to an actor fulfilling the requirement (so that)"
