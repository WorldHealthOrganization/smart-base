...
* ^status = #active
* functional 0..8 id "Functional Requirements" "Functional requirements for the system"
* nonfunctional 0..8 id "Non-Functional Requirements" "Non-functional requirements for the system"