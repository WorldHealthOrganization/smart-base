...
* decisionLogic 0..* DecisionSupportLogicSet "Decision-Support Logic" "Decision-support logic and algorithms to support appropriate service delivery"
* indicators 0..* ProgramIndicatorSet "Program Indicators" "Core set of indicators for decision-making, performance metrics and reporting"
