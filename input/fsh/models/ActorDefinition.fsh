...
* identifier 0..* Identifier "Unique identifier for the actor"
* status 1..1 code "The status of the actor definition" 
* name 1..1 string "Computer-friendly name for the actor"
* title 0..1 string "Human-friendly title for the actor"
* experimental 0..1 boolean "Whether the actor is experimental"
* description 0..1 markdown "Description of the actor"
